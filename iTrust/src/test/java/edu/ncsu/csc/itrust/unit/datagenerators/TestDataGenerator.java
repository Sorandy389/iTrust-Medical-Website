...
public class TestDataGenerator {
	...
	/* Obstetrics Records Test Data Generator
	 * 
	 */
	public void obRec() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/InsertIteration1/obRec1.sql");
	}

	public void obOfficeVisitRec() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/InsertIteration1/obOfficeVisit.sql");
	}

	public void ultrasoundRec() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/InsertIteration1/ultrasoundRec.sql");
	}

	public void patientPrescriptionRec() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/InsertIteration1/patientPrescription.sql");
	}

	public void chv() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/CHV1.sql");
	}
