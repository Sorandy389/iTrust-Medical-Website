...
import edu.ncsu.csc.itrust.model.officeVisit.obstetricsOfficeVisit.ObstetricsOfficeVisitData;
...
public class ObstetricsOfficeVisitController extends iTrustController {
	...
	private ObstetricsOfficeVisitData officeVisitData;
	private SessionUtils sessionUtils;

	public ObstetricsOfficeVisitController() throws DBException {
		officeVisitData = new ObstetricsOfficeVisitMySQL();
	...
	public ObstetricsOfficeVisitController(DataSource ds, SessionUtils sessionUtils) {
		officeVisitData = new ObstetricsOfficeVisitMySQL(ds);
...
//		}
	 ...
	 */
	public List<ObstetricsOfficeVisit> getOfficeVisitsForPatient(String pid) {
	 ...
	 */
	public List<ObstetricsOfficeVisit> getBabyOfficeVisitsForPatient(String pid) {
		return getOfficeVisitsForPatient(pid).stream().filter((o) -> {
			return isPatientABaby(o.getPatientID(), o.getCreatedDate());
		}).collect(Collectors.toList());
	}
	 ...
	 *         if no office visit exists during that age range
	 */
	public List<ObstetricsOfficeVisit> getBabyOfficeVisitsForCurrentPatient() {
	 ...
	 *         if no office visit exists during that age range
	 */
	public List<ObstetricsOfficeVisit> getChildOfficeVisitsForPatient(String pid) {
		return getOfficeVisitsForPatient(pid).stream().filter((o) -> {
			return isPatientAChild(o.getPatientID(), o.getCreatedDate());
		}).collect(Collectors.toList());
	}
	 ...
	 */
	public List<ObstetricsOfficeVisit> getChildOfficeVisitsForCurrentPatient() {
	 ...
	 *         if no office visit exists during that age range
	 */
	public List<ObstetricsOfficeVisit> getAdultOfficeVisitsForPatient(String pid) {
		return getOfficeVisitsForPatient(pid).stream().filter((o) -> {
			return isPatientAnAdult(o.getPatientID(), o.getCreatedDate());
		}).collect(Collectors.toList());
	}
	 ...
	 *         list if no office visit exists during that age range
	 */
	public List<ObstetricsOfficeVisit> getAdultOfficeVisitsForCurrentPatient() {
	...
	public void logViewOfficeVisit() {
		...
		if (id != null) {
			...
			ObstetricsOfficeVisit ov = getVisitByID(Long.toString(id));
			long patientMID = ov.getPatientID();
			LocalDateTime d = ov.getCreatedDate();
