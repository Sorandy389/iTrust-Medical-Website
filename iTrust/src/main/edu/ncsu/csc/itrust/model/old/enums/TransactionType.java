...
public enum TransactionType {
	...
	CREATE_INITIAL_OBSTETRIC_RECORD(9300, "Create Inital Obstetric Record", "Initial Obstetric Record", true),
	...
	/**CREATE_INITIAL_PRESCRIPTION_RECORD**/
	CREATE_INITIAL_PRESCRIPTION_RECORD(9900, "Create initial prescription record", "Create initial prescription record", true),
	/**VIEW_INITIAL_PRESCRIPTION_RECORD**/
	VIEW_INITIAL_PRESCRIPTION_RECORD(9901, "View initial prescription record", "View initial prescription record", true),
	/**EDIT_INITIAL_PRESCRIPTION_RECORD**/
	EDIT_INITIAL_PRESCRIPTION_RECORD(9902, "Edit initial prescription record", "Edit initial prescription record", true),
	/**DELETE_INITIAL_PRESCRIPTION_RECORD**/
	DELETE_INITIAL_PRESCRIPTION_RECORD(9903, "Delete initial prescription record", "Delete initial prescription record", true),
	;
	/**
