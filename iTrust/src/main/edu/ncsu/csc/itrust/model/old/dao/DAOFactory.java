...
//	}
	...
	public ObstetricsPatientDAO getObDAO(){
		return new ObstetricsPatientDAO(this);
	}

	public UltrasoundRecordDAO getUltrasoundecordDAO() {
		return new UltrasoundRecordDAO(this);
	}
	
	public PatientPrescriptionDAO getPatientPrescriptionDAO(){
		return new PatientPrescriptionDAO(this);
	}
	/**
	 *
	 * @return this DAOFactory's PersonnelDAO
    ...
    public ChildHospitalVisitDAO getChildHospitalVisitDAO() {
        return new ChildHospitalVisitDAO(this);
    }
