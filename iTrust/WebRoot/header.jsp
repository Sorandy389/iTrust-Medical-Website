...
<title><%=StringEscapeUtils.escapeHtml("" + (pageTitle))%></title>
	...
	<script src="/iTrust/js/moment.js" type="text/javascript"></script>
	<script src="/iTrust/js/bootbox.min.js" type="text/javascript"></script>
	<script src="https://addevent.com/libs/atc/1.6.1/atc.min.js" type="text/javascript" async defer></script>
</head>
<body>
