...
<%@page import="edu.ncsu.csc.itrust.logger.ObstetricsRecordsLogger"%>
<%@page import="edu.ncsu.csc.itrust.logger.ObstetricsOfficeVisitLogger"%>
<%@page import="edu.ncsu.csc.itrust.logger.PrescriptionRecordLogger"%>
<%@page import="edu.ncsu.csc.itrust.logger.ChildbirthHospitalVisitLogger"%>
<%
...
ObstetricsRecordsLogger oblogger = new ObstetricsRecordsLogger(prodDAO);
ObstetricsOfficeVisitLogger ObOfficeVisitlogger = new ObstetricsOfficeVisitLogger(prodDAO);
ChildbirthHospitalVisitLogger chvLogger = new ChildbirthHospitalVisitLogger(prodDAO);
PrescriptionRecordLogger prescriptionRecordLogger = new PrescriptionRecordLogger(prodDAO);
