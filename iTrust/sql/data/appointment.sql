...
('9000000012', '1', CONCAT(ADDDATE(CURDATE(),7), ' 10:45:00'), 'Childbirth', 'Follow-up for the obstetrics care.'),
('9000000012', '1', CONCAT(ADDDATE(CURDATE(),1), ' 8:45:00'), 'Childbirth', 'Follow-up for the obstetrics care.'),
('9000000012', '2', CONCAT(ADDDATE(CURDATE(),6), ' 10:45:00'), 'Childbirth', 'Follow-up for the obstetrics care.'),
('9000000000', '1', CONCAT(YEAR(NOW())+1, '-06-04 10:30:00'), 'Childbirth', 'Follow-up for the obstetrics care.');
