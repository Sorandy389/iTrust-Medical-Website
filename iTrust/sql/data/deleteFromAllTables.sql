...
DELETE FROM obstetricsrecord;
ALTER TABLE obstetricsrecord AUTO_INCREMENT = 0;
...
DELETE FROM ultrasoundfile;
ALTER TABLE ultrasoundfile AUTO_INCREMENT = 0;

DELETE FROM patientprescription;
ALTER TABLE patientprescription AUTO_INCREMENT = 0;

DELETE FROM childhospitalvisit;
ALTER TABLE childhospitalvisit AUTO_INCREMENT = 0;
